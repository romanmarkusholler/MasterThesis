...
const INV_MAT: [Elem; STATE_WIDTH * STATE_WIDTH] = [
    Elem::new(1218786605962040818),
    Elem::new(296461606855631550),
    Elem::new(757624106408836184),
    Elem::new(527042856632233867),
    Elem::new(2668154461700683952),
    Elem::new(4512804459913502487),
    Elem::new(1284666963041070051),
    Elem::new(2898735711477286269),
    Elem::new(2668154461700683952),
    Elem::new(4512804459913502487),
    Elem::new(1284666963041070051),
    Elem::new(2898735711477286269),
...
const ALPHAS: [Elem; STATE_WIDTH] = [
    ...
    Elem::new(1009590791150226335),
    Elem::new(3820198684491362671),
    Elem::new(2019181582300452670),
    Elem::new(218164480109542669),
    Elem::new(3028772373450679005),
    Elem::new(1227755271259769004),
    Elem::new(4038363164600905340),
    Elem::new(2237346062409995339),
    Elem::new(436328960219085338),
];
...
const BETAS: [Elem; STATE_WIDTH] = [
    ...
    Elem::new(822554141855617420),
    Elem::new(1850746819175139195),
    Elem::new(3290216567422469680),
    Elem::new(529338391065562538),
    Elem::new(2791362281168510443),
    Elem::new(853038246667220721),
    Elem::new(3937616278625786046),
    Elem::new(2821846385980113744),
    Elem::new(2117353564262250152),
];
